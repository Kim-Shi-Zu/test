...
// MDX components with shadcn/ui styling
const components = {
  h1: Typography.H1,
  h2: Typography.H2,
  h3: Typography.H3,
...
export default function Lesson3({ source, frontMatter }: { source: any, frontMatter: any }) {
...
export async function getStaticProps() {
  const lessonPath = path.join(process.cwd(), 'content/module1/lesson_1_3.md');
