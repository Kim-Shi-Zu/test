...
import DocumentationGenerator from '@/components/projects/documentation-generator';
...
export default function Lesson6({ source, frontMatter }: { source: any, frontMatter: any }) {
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Project Demo: {frontMatter.project?.name || 'Documentation Generator'}</CardTitle>
        </CardHeader>
        <CardContent>
...
export async function getStaticProps() {
  const lessonPath = path.join(process.cwd(), 'content/module1/lesson_1_6.md');
